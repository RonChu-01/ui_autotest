...
if exists(Template(r"tpl1553493935181.png", record_pos=(-0.448, 0.044), resolution=(1080, 1920))
):


    touch(Template(r"tpl1553493935181.png", record_pos=(-0.448, 0.044), resolution=(1080, 1920))
    )
